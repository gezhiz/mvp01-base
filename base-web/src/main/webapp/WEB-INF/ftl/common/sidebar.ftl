    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-user">
            <div class="category-content">
                <div class="media">
                    <a href="#" class="media-left"><img src="${request.contextPath}/static/assets/images/placeholder.jpg" class="img-circle img-sm" alt=""></a>
                    <div class="media-body">
                        <span class="media-heading text-semibold">Admin</span>
                        <div class="text-size-mini text-muted">
                            <i class="icon-pin text-size-small"></i> 系统管理员
                        </div>
                    </div>
        ...
        <div class="sidebar-category sidebar-category-visible">
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <li class="active"><a href="index.html"><i class="icon-home4"></i> <span>工作台</span></a></li>
                    <li>
                        <a href="#"><i class="icon-stack2"></i> <span>角色管理</span></a>
                        <ul>
                            <li><a href="layout_navbar_fixed.html">角色列表</a></li>
                            <li><a href="layout_navbar_sidebar_fixed.html">新增角色</a></li>
                        </ul>
                    </li>
